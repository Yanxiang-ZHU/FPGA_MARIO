...
#
# Script generated by Vivado on Wed May 28 12:56:02 +0800 2025
...
#
# Usage        : dist_mem_gen_2.sh
#                dist_mem_gen_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dist_mem_gen_2.sh [-reset_run]
#                dist_mem_gen_2.sh [-reset_log]
#                dist_mem_gen_2.sh [-help]
#
...
#                script (type 'dist_mem_gen_2.sh -help' for more information).
#
...
# script info
echo -e "dist_mem_gen_2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dist_mem_gen_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dist_mem_gen_2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dist_mem_gen_2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dist_mem_gen_2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: dist_mem_gen_2.sh [-step]\n\
Usage: dist_mem_gen_2.sh [-lib_map_path]\n\
Usage: dist_mem_gen_2.sh [-reset_run]\n\
Usage: dist_mem_gen_2.sh [-reset_log]\n\
Usage: dist_mem_gen_2.sh [-keep_index]\n\
